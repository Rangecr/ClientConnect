        ...
        <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark" style="background: rgb(0,0,0);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{ route('log.logs') }}"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-receipt" style="font-size: 25px;margin-right: 10px;">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                    ...
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle me-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        <ul class="navbar-nav flex-nowrap ms-auto">
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small">{{ $user->name }}</span><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-person" style="font-size: 20px;">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Log</h4><button class="btn-close" type="button" aria-label="Close" data-bs-dismiss="modal"></button>
                            </div>
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col">
                                        <p style="color: var(--bs-emphasis-color);font-weight: bold;margin-bottom: 0px;">Name</p>
                                        <p>{{ $log->customer->name }}</p>
                                    </div>
                                    <div class="col">
                                        <p style="color: var(--bs-emphasis-color);font-weight: bold;margin-bottom: 0px;">Type of Interaction</p>
                                        <p>{{ $log->type }}</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <p style="color: var(--bs-emphasis-color);font-weight: bold;margin-bottom: 0px;">Date Created</p>
                                        <p>{{ $log->created_at }}</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <p style="color: var(--bs-emphasis-color);font-weight: bold;margin-bottom: 0px;">Notes</p>
                                        <p>{{ $log->notes }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal-body">
                                <form id="report-form">
                                    <div class="row" style="margin-bottom: 10px;">
                                        <div class="col">
                                            <p style="margin-bottom: 10px;">Start Date</p><input class="form-control" type="date" style="border-radius: 5px;">
                                        </div>
                                        <div class="col">
                                            <p style="margin-bottom: 10px;">End Date</p><input class="form-control" type="date" style="border-radius: 5px;">
                                        </div>
                                    </div>
                                </form>
                            </div>
                            <div class="modal-footer"><button class="btn btn-light" type="button" data-bs-dismiss="modal">Close</button><button class="btn btn-primary" type="submit" style="background: rgb(183,0,0);border-width: 0px;" form="report-form"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-file-pdf-fill" style="font-size: 20px;margin-right: 5px;">
                                    ...
                                    </svg>PDF</button><button class="btn btn-primary" type="submit" style="background: #008c5a;border-width: 0px;" form="report-form"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-file-excel-fill" style="font-size: 20px;margin-right: 5px;">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('log.add') }}" id="log-form" method="post">
                                    ...
                                    <div class="row" style="margin-bottom: 10px;">
                                        <div class="col">
                                            <p style="margin-bottom: 0px;">Customer</p><select name="cust_id" class="form-select select2" required="" style="width: 201.2px;border-radius: 5px;">
                ...
                <div class="container-fluid">
                    <div class="row" style="margin-bottom: 10px;">
                        <div class="col"><a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" style="background: rgb(0,0,0);" data-bs-toggle="modal" data-bs-target="#modal-log"><svg xmlns="http://www.w3.org/2000/svg" viewBox="-64 0 512 512" width="1em" height="1em" fill="currentColor" class="fa-sm text-white-50" style="font-size: 16px;">
                        ...
                        <div class="col-lg-4 col-xxl-6" style="width: 370px;">
                            <div class="card shadow mb-3">
                                <div class="card-header py-3">
                                    <div class="row">
                                        <div class="col">
                                            <p class="text-primary m-0 fw-bold" style="color: rgb(0,0,0) !important;">Email Logs</p>
                                        </div>
                                        <div class="col"><input type="search" class="form-control form-control-sm" aria-controls="dataTable" placeholder="Search"></div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    @if ($emails->isEmpty())
                                    ...
                                    <div class="row row-mail row-email" style="margin-bottom: 10px;" data-bs-toggle="modal" data-bs-target="#modal-cust-log-{{ $email->id }}" type="button">
                        ...
                        <div class="col">
                            <div class="card shadow mb-3">
                                <div class="card-header py-3">
                                    <div class="row">
                                        <div class="col">
                                            <p class="text-primary m-0 fw-bold" style="color: rgb(0,0,0) !important;">Call Logs</p>
                                        </div>
                                        <div class="col"><input type="search" class="form-control form-control-sm" aria-controls="dataTable" placeholder="Search"></div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row row-call" style="margin-bottom: 10px;" data-bs-toggle="modal" data-bs-target="#modal-cust-log-{{ $call->id }}" type="button">
                        ...
                        <div class="col">
                            <div class="card shadow mb-3">
                                <div class="card-header py-3">
                                    <div class="row">
                                        <div class="col">
                                            <p class="text-primary m-0 fw-bold" style="color: rgb(0,0,0) !important;">Meeting Logs</p>
                                        </div>
                                        <div class="col"><input type="search" class="form-control form-control-sm" aria-controls="dataTable" placeholder="Search"></div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row row-meeting" style="margin-bottom: 10px;" data-bs-toggle="modal" data-bs-target="#modal-cust-log-{{ $meeting->id }}" type="button">
