                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-flex">
                        <div class="flex-grow-1 bg-register-image"
                            style="background-image: url(&quot;dogs/image2.jpeg&quot;);"><img
                                alt="template, layout, website"
                                src="{{ asset('assets/img/gcc78c4cda78f0d3207b7d245b1a62096a1cd6ebc9b3bffecf300c58a6536a83d0a63a77a2a67fecbf29b4c98c5cb1045eddcf82e3d9899ceda8961c8d6b28c73_640.png') }}"
                        ...
                        <div class="p-5">
                            ...
                            <form action="{{ route('register') }}" class="user" method="post">
                                ...
                                <div class="mb-3"><input class="form-control form-control-user" type="tel"
                                        aria-describedby="emailHelp" placeholder="Phone Number" name="p_numb"
                                        minlength="8" maxlength="15" required=""></div>
                                <div class="row mb-3">
                                ...
                                @if (session()->has('alert'))
                                    @if (session('alert') === 'email')
                                        <p style="color: var(--bs-danger);font-weight: bold;font-size: 13px;">Email already exist</p>
                                    @endif
                                @endif
                            ...
                            <div class="text-center"><a class="small" href="{{ route('entry.reset_pass_1') }}">Forgot Password?</a>
                            </div>
                            <div class="text-center"><a class="small" href="{{ route('entry.login') }}">Already have an
                                    account? Login!</a></div>
                        </div>
                    </div>
                </div>
