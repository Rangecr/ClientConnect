                ...
                <div class="modal fade" role="dialog" tabindex="-1" id="modal-cust-log">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer"><button class="btn btn-light" type="button" data-bs-dismiss="modal">Close</button><button class="btn btn-primary" type="button" style="background: var(--bs-red);border-width: 0px;">Delete</button></div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-4 col-xxl-6">
                            <div class="card shadow mb-3">
                                <div class="card-header py-3">
                                    <p class="text-primary m-0 fw-bold" style="color: rgb(0,0,0) !important;">Customer's Info</p>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                ...
                                <div class="col">
                                    <div class="card shadow mb-4">
                                        <div class="card-header py-3">
                                            <div class="row">
                                                <div class="col">
                                                    <h6 class="text-primary fw-bold m-0" style="color: rgb(0,0,0)!important;">Customer's Log</h6>
                                                </div>
                                                <div class="col" style="text-align: right;"><a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" style="background: rgb(0,0,0);" data-bs-toggle="modal" data-bs-target="#modal-log"><svg xmlns="http://www.w3.org/2000/svg" viewBox="-64 0 512 512" width="1em" height="1em" fill="currentColor" class="fa-sm text-white-50" style="font-size: 16px;">
