        ...
        <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark"
            ...
            <div class="container-fluid d-flex flex-column p-0"><a
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{ route('customer.customers') }}"><svg
                                xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 24 24" width="1em"
                                fill="currentColor" style="font-size: 25px;margin-right: 10px;">
                                <path d="M0 0h24v24H0z" fill="none"></path>
                                <path
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Add Customer</h4><button class="btn-close" type="button"
                                    aria-label="Close" data-bs-dismiss="modal"></button>
                            </div>
                            <div class="modal-body">
                                <form id="cust-form" action="{{ route('customer.add') }}" method="post">
                                    @csrf
                                    <div class="row" style="margin-bottom: 10px;">
                                        <div class="col">
                                            <p style="margin-bottom: 0px;">Name</p><input name="name"
                                                class="form-control" type="text" required="">
                                        </div>
                                        <div class="col">
                                            <p style="margin-bottom: 0px;">Email</p><input name="email"
                                                class="form-control" type="email" required="">
                                        </div>
                                    </div>
                                    <div class="row" style="margin-bottom: 10px;">
                                        <div class="col">
                                            <p style="margin-bottom: 0px;">Phone Number</p><input name="p_numb"
                                                class="form-control" type="tel" required="">
                                        </div>
                                        <div class="col">
                                            <p style="margin-bottom: 0px;">Address</p><input name="address"
                                                class="form-control" type="text" required="">
                                        </div>
                                    </div>
                                    <div class="row">
                            ...
                            <div class="modal-footer"><button class="btn btn-light" type="button"
                                    ...
                                    type="submit" style="background: rgb(0,0,0);border-width: 0px;"
                                    form="cust-form">Add</button></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer"><button class="btn btn-light" type="button"
                                    ...
                                    </svg>PDF</button><button class="btn btn-primary" type="button"
                                    style="background: #008c5a;border-width: 0px;"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                    ...
                                    <div class="dropdown"><button class="btn btn-primary dropdown-toggle"
                                        ...
                                        <div class="dropdown-menu"><a class="dropdown-item" href="#">Date
                                                ...
                                                href="#"><span
                                                    ...
                                                    | Alphabetically (Z to A)</span></a></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
