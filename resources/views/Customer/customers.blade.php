    ...
    <div id="wrapper">
        <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark" style="background: rgb(0,0,0);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{ route('customer.customers') }}"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 24 24" width="1em" fill="currentColor" style="font-size: 25px;margin-right: 10px;">
                                <path d="M0 0h24v24H0z" fill="none"></path>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="alert alert-success alert-dismissible" role="alert"><button class="btn-close" type="button" aria-label="Close" data-bs-dismiss="alert"></button><span><strong>Customer added successfully!</strong></span></div>
                <div class="alert alert-success alert-dismissible" role="alert" style="color: var(--bs-danger-text-emphasis);border-color: var(--bs-danger-border-subtle);background: var(--bs-danger-bg-subtle);"><button class="btn-close" type="button" aria-label="Close" data-bs-dismiss="alert"></button><span><strong>5 Selected Customer Deleted!</strong></span></div>
                            ...
                            <div class="modal-body">
                                <form id="cust-form">
                                    <div class="row" style="margin-bottom: 10px;">
                                        <div class="col">
                                            <p style="margin-bottom: 0px;">Name</p><input class="form-control" type="text" required="">
                                        </div>
                                        <div class="col">
                                            <p style="margin-bottom: 0px;">Email</p><input class="form-control" type="email" required="">
                                        </div>
                                    </div>
                                    <div class="row" style="margin-bottom: 10px;">
                                        <div class="col">
                                            <p style="margin-bottom: 0px;">Phone Number</p><input class="form-control" type="tel" required="">
                                        </div>
                                        <div class="col">
                                            <p style="margin-bottom: 0px;">Address</p><input class="form-control" type="text" required="">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <p style="margin-bottom: 0px;">Notes</p><textarea class="form-control" required=""></textarea>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            <div class="modal-footer"><button class="btn btn-light" type="button" data-bs-dismiss="modal">Close</button><button class="btn btn-primary" type="submit" style="background: rgb(0,0,0);border-width: 0px;" form="cust-form">Add</button></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal fade" role="dialog" tabindex="-1" id="modal-delete">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Delete (5 Selected)</h4><button class="btn-close" type="button" aria-label="Close" data-bs-dismiss="modal"></button>
                            </div>
                            <div class="modal-body">
                ...
                <div class="container-fluid">
                    <div class="row" style="margin-bottom: 10px;">
                        <div class="col"><a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" style="background: rgb(0,0,0);margin-right: 10px;" data-bs-toggle="modal" data-bs-target="#modal-customer"><i class="icon ion-android-person fa-sm text-white-50" style="font-size: 15px;"></i>&nbsp;Add Customer</a><a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" style="background: var(--bs-danger);border-width: 0px;" data-bs-toggle="modal" data-bs-target="#modal-delete">Delete Selected Customer</a></div>
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold" style="color: rgb(0,0,0)!important;">Customers Info</p>
                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>2008/11/28</td>
                                            <td>$162,700</td>
                                            <td style="font-style: italic;text-decoration:  underline;"><button class="btn btn-primary btn-view-cust" type="button" style="background: rgba(78,115,223,0);color: rgb(0,0,0);border-width: 0px;font-style: italic;">View Details</button></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td>Cell 1</td>
