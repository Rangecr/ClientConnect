        ...
        <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark"
            ...
            <div class="container-fluid d-flex flex-column p-0"><a
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{ route('helpdesk.helpdesk') }}"><svg
            ...
            <div id="content">
                ...
                @if (session()->has('alert'))
                    @if (session('alert') === 'success')
                        <div class="alert alert-success alert-dismissible" role="alert"><button class="btn-close"
                                ...
                                data-bs-dismiss="alert"></button><span><strong>Ticket added
                                    successfully!</strong></span></div>
                    @endif
                @endif
                @if (session()->has('alert'))
                ...
                @if (session()->has('alert'))
                    @if (session('alert') === 'empty')
                        <div class="alert alert-success alert-dismissible" role="alert"
                            style="color: var(--bs-danger-text-emphasis);border-color: var(--bs-danger-border-subtle);background: var(--bs-danger-bg-subtle);">
                            <button class="btn-close" type="button" aria-label="Close"
                                data-bs-dismiss="alert"></button><span><strong>No ticket deleted! Please select at
                            ...
                            <div class="modal-body">
                                <form action="{{ route('ticket.add') }}" method="post" id="ticket-form">
                                    ...
                                    <div class="row" style="margin-bottom: 10px;">
                                        <div class="col">
                                            <p style="margin-bottom: 0px;">Requester</p><select name="cust_id"
                ...
                <div class="modal fade" role="dialog" tabindex="-1" id="modal-delete">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer"><button class="btn btn-light" type="button"
                                    data-bs-dismiss="modal">Close</button><button form="delete"
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" style="margin-bottom: 10px;">
                                ...
                                <div class="card-body">
                                    <div class="row g-0 align-items-center">
                                        ...
                                        <div class="col-auto"><svg xmlns="http://www.w3.org/2000/svg" width="1em"
                                                ...
                                                style="font-size: 45px;color: rgb(0,0,0)!important;">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                <path d="M15 5l0 2"></path>
                                                <path d="M15 11l0 2"></path>
                                                <path d="M15 17l0 2"></path>
                        ...
                        <div class="col">
                            <div class="card shadow border-left-primary py-2"
                                style="border-left-color: rgb(231,74,59)!important;">
                                <div class="card-body">
                                    <div class="row g-0 align-items-center">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span
                                        ...
                                        <div class="col-auto"><svg xmlns="http://www.w3.org/2000/svg" width="1em"
                                                ...
                                                stroke-linejoin="round"
                                                class="icon icon-tabler icon-tabler-ticket fa-2x text-gray-300"
                                                style="font-size: 45px;color: rgb(231,74,59)!important;">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                <path d="M15 5l0 2"></path>
                                                <path d="M15 11l0 2"></path>
                                                <path d="M15 17l0 2"></path>
